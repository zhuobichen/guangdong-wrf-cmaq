...
COMPARISON_CONFIGS = [
    ...
    # ],
    [
        '/data/workspace/GuangDong/mcipout_processed_hourly/2030_mcipout_01.csv',
        '/data/workspace/GuangDong/mcipout_processed_hourly/2023_mcipout_01.csv',
        2030, 2023,
        '2030_minus_2023'
    ],
...
def main():
    ...
    VARIABLES_TO_PROCESS = ['Heatwave_Days']  # 处理所有基础变量
